import{i as o}from"./mock-api-476da0d3.js";import{P as h}from"./index-9f5f841f.js";import{b5 as e,V as D,Q as p,B as f}from"./antd-090f1744.js";import{d as r,l as u,E as t,f as m,u as d,c as g,r as F}from"./vue-d56f5f31.js";import{u as i}from"./index-88cd51d8.js";import"./entry/index-1163f12d-1703821863576.js";import"./useContentViewHeight-17e909ee.js";import"./useWindowSizeFn-ab2a372a.js";import"./onMountedOrActivated-60a5193f.js";const C=[{label:"Jack",value:"Jack"},{label:"Lucy",value:"Lucy"},{label:"Lutz",value:"Lutz"}],v=r({setup(){const a=m("Lutz"),{data:n,loading:l}=i(()=>o(a.value),{refreshDeps:[a]});return()=>u(p,{title:"Ref 依赖刷新"},{default:()=>[u(e,null,{default:()=>[u(e.Paragraph,null,{default:()=>[t("useRequest 提供了一个"),u(e.Text,{type:"danger"},{default:()=>[t(" options.refreshDeps ")]}),t("参数，当它的值变化后，会重新触发请求。")]}),u(e.Paragraph,null,{default:()=>[u(e.Text,null,{default:()=>[u("pre",null,[`const select = ref('Lutz');
